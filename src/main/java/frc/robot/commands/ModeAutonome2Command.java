...
public class ModeAutonome2Command extends SequentialCommandGroup {
  ...
  public ModeAutonome2Command() {
      ...
      addCommands(new LimelightRotationCommand(drivetrain, limelight, controller, 0/** a changer */)); 
      ...
      addCommands(new LimelightRotationCommand(drivetrain, limelight, controller, 0)); //tourne robot
      addCommands(new LimelightXCommand(drivetrain, limelight, controller, 0/** a changer */, true)); //va vers truc a scorer
      addCommands(new LimelightYCommand(drivetrain, limelight, controller, 0/** a changer */, true)); //stabilise
